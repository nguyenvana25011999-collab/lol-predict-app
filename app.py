...
def fetch_and_train():
    ...
    try:
        ...
        # TỰ ĐỘNG CHUYỂN SANG DỮ LIỆU DỰ PHÒNG NẾU LỖI MẠNG/BỊ CHẶN
        st.toast('Đang dùng dữ liệu mô phỏng cục bộ do máy chủ bị chặn IP', icon='⚠️')
        mock_data = [
        ...
        # Nhân bản dữ liệu để AI đủ trọng số học thuật
...
if st.button("Phân tích"):
    ...
    if len(picks) == 10:
        ...
        # Bỏ qua cảnh báo các tướng chưa có trong dữ liệu
        ...
        col1.metric(f"Dự đoán thời gian", f"{pred_time:.1f} phút")
        col2.metric(f"Dự đoán tổng Kills", f"{pred_kills:.0f} mạng")
    else:
